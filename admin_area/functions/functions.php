...
function getCatPro()
	{
		...
		if($count_cats==0)
		{
			echo "<h2 style='padding:20px; color:red;'>There is no product in this catrgory!</h2>";
		}
...
function getBrandPro()
	{
		...
		if($count_brands==0)
		{
			echo "<h2 style='padding:20px; color:red;'>No products were associated with this brand!</h2>";
		}
