	...
	<form method="post" action="">
		...
		<table width=500" align="center" bgcolor="skyblue">
			...
			<tr>
				...
				<td><input type="text" name="pass" placeholder="Enter Password" required/></td>
			</tr>
			...
			<tr align="center">
				<td colspan="3" style="padding-bottom:10px; padding-top:5px;"><input type="submit" name="login" value="Login"/></td>
			</tr>
		</table>
...
<?php
		if(isset($_POST['login']))
		{
			...
			if($check_customer>0 AND $check_cart==0)
			{
				...
				echo"<script>window.open('You logged in successfully,Thanks!')</script>";
